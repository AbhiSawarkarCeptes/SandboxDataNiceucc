...
const columns = [
    ...
    { label: 'Demand Raised', fieldName: 'demands', type: 'currency', wrapText: true, hideDefaultActions: true, typeAttributes: { minimumFractionDigits: 0, maximumFractionDigits: 2 } },
    ...
    { label: 'Future Demand', fieldName: 'futureDemand', type: 'currency', wrapText: true, hideDefaultActions: true, typeAttributes: { minimumFractionDigits: 0, maximumFractionDigits: 2 } },
    ...
    { label: 'Overdue Amount', fieldName: 'due', type: 'currency', wrapText: true, hideDefaultActions: true, typeAttributes: { minimumFractionDigits: 0, maximumFractionDigits: 2 } },
    { label: 'Balance', fieldName: 'fullDue', type: 'currency', wrapText: true, hideDefaultActions: true, typeAttributes: { minimumFractionDigits: 0, maximumFractionDigits: 2 } },
    ...
    { label: 'Raised Cancellation Date', fieldName: 'raisedCancellationDate', hideDefaultActions: true }
...
export default class TerminationDashboardForCollection extends LightningElement {
    ...
    getOverDueBookings() {
        if(this.createNewCancellationRequest == true){
            this.handleNewCancellationRequestClick()
        }
        if(this.resubmittedByAuditTeam == true){
            this.handleResubmittedByAuditTeamClick();
        }
        if(this.resubmittedByAccountTeam == true){
            this.handleResubmittedByAccountTeamClick();
        }
        if(this.rejectedByAccounts == true){
            this.handleRejectedbyAccountsClick();
        }
        if(this.rejectedByAudit == true){
            this.handleRejectedByAuditTeamClick();
        }
        if(this.submittedbyDLd == true){
            this.handleSubmittedByDLDTeamClick();
        }
        if(this.submittedbyCRM == true){
            this.handleSubmittedByCRMTeamClick();
        }
    ...
    handleResubmittedByAccountTeamClick(shouldNotRefresh) {
    ...
    handleResubmittedByAuditTeamClick(shouldNotRefresh) {
        this.createNewCancellationRequest = false;
        ...
        this.submittedbyDLd = false;
        this.submittedbyCRM = false;
        let terminationStatus =['Resubmitted to collections by audit','Resubmitted to Collection and Accounts by audit'];
    ...
    handleRejectedbyAccountsClick(shouldNotRefresh) {
        this.createNewCancellationRequest = false;
        this.resubmittedByAuditTeam = false;
        this.resubmittedByAccountTeam = false;
    ...
    handleRejectedByAuditTeamClick(shouldNotRefresh) {
        this.createNewCancellationRequest = false;
        this.resubmittedByAuditTeam = false;
        this.resubmittedByAccountTeam = false;
        this.rejectedByAccounts = false;
    ...
    handleNewCancellationRequestClick(shouldNotRefresh) {
    ...
    handleSubmittedByDLDTeamClick(shouldNotRefresh){
        this.createNewCancellationRequest = false;
        this.resubmittedByAuditTeam = false;
        this.resubmittedByAccountTeam = false;
        this.rejectedByAccounts = false;
        ...
        this.submittedbyCRM = false;
        let terminationStatus =['Submitted to collections by DLD'];
        this.termiantionStatusForResubmission = 'Resubmitted to audit by collections';
        this.terminationStatusForRejection = 'Rejected by Collections';
        this.submitedToWhom = 'Audit';
        this.terminationStatus = terminationStatus;
    ...
    handleSubmittedByCRMTeamClick(shouldNotRefresh){
        this.createNewCancellationRequest = false;
        this.resubmittedByAuditTeam = false;
        this.resubmittedByAccountTeam = false;
        this.rejectedByAccounts = false;
        ...
        let terminationStatus =['Allocate To Collection By CRM'];

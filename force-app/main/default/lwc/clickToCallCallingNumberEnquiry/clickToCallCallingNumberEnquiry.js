...
import fetchOriginalNumber from '@salesforce/apex/ClickToCallEnquiryController.originalCallingNumber';
export default class ClickToCallCallingNumberEnquiry extends NavigationMixin(LightningElement) {
    @api recordId;
    showSpinner = false;
    phonenum;

...
import getMetadataConfig from '@salesforce/apex/BrokerRegFieldUpdateReqController.getCustomeMetadatConfig';
...
export default class BrokerRegFieldUpdateRequest extends LightningElement {
    @api recordId; showSpinner=false; 
    objectApiName ='Broker_Registration__c'; dummyRecord;

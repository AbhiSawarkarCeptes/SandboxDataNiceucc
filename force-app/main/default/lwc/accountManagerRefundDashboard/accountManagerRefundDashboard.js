...
import transactionRequestRecord from '@salesforce/apex/AccountManagerRefundDBController.transactionRequestRecord';
import submittedToAccount from '@salesforce/apex/AccountManagerRefundDBController.submittedToAccount';
...
export default class AccountManagerRefundDashboard extends LightningElement {
    columns = columns;
    backupResult = [];
    data = [];
    searchTerm;
    ...
    handleInitialization() {
        ...
        this.refundStatus = ['Resubmit to Account Manager Review'];

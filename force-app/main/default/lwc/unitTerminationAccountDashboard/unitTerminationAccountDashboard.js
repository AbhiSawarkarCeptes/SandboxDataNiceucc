...
export default class UnitTerminationAccountDashboard extends LightningElement {
    columns = columns;
    backupResult = [];
    data = [];
    searchTerm;
    ...
    handleRequestForCancellation(event) {
        ...
        if (this.customerInitiatedTermination && !actionName.includes('approve')) {
    ...
    get getVisibilityOfFilterSelection() {
        return this.submittedToAccount || this.resubmittedByAuditTeam ||   this.resubmittedByCollectionTeam || this.customerInitiatedTermination;
    }

...
import createPaymentRequest from '@salesforce/apex/PaymentRequestFormController.createPaymentRequest';
import unitDetails from '@salesforce/apex/PaymentRequestFormController.unitDetails';
import getUnitId from '@salesforce/apex/PaymentRequestFormController.getUnitId';
import getPaymentRequestDetails from '@salesforce/apex/PaymentRequestFormController.getPaymentRequestDetails';
import getCurrencyRate from '@salesforce/apex/PaymentRequestFormController.getCurrencyRate';
import { CloseActionScreenEvent } from 'lightning/actions';
import updateUploadedFileName from '@salesforce/apex/PaymentRequestFormController.updateUploadedFileName';
...
const BOOKINGFIELDS = ['Booking__c.Name','Booking__c.Allow_Payment_Request__c', 'Booking__c.Termination_Status__c','Booking__c.Cancellation_Allocation__c','Booking__c.Termination_Process_Status__c'];

export default class PaymentRequestForm extends NavigationMixin(LightningElement) {
    ...
    wiredRecord({ error, data }) {
        if (error) {
            ...
            if((data.fields.Termination_Status__c.value == 'Raised to DLD Team' && data.fields.Cancellation_Allocation__c.value != 'Allocate to CRM Team')){

...
import getMetadataConfig from '@salesforce/apex/BrokerAccountFieldUpdateReqController.getCustomeMetadatConfig';
import insertRequestData from '@salesforce/apex/BrokerAccountFieldUpdateReqController.insertRequestData';
import { loadStyle, loadScript } from 'lightning/platformResourceLoader';
import myStaticStyles from '@salesforce/resourceUrl/myStaticStyles'

export default class BrokerAccountFieldUpdateRequest extends LightningElement {
    @api recordId; showSpinner=false; 
        ...
        if (inputFields) {
            ...
            inputFields.forEach(field => {
                if(this.record[field.name]!='' && this.record[field.name]!=null){
                    ...
                    obj.Status__c = 'Pending With CHRM OPS Manager';
                    obj.Broker_Account__c = this.recordId;

...
import getBookingData from '@salesforce/apex/CRMSiteVisitCopyController.getBookingData';
import getRecordType from '@salesforce/apex/CRMSiteVisitCopyController.getRecordTypeId';
export default class createCRMSiteVisitFormCopy extends NavigationMixin(LightningElement) {
    @track showSpinner = false;
    @track Customer_Registration__c = {
        Application_Booking__c: null,
        Property__c: null,
        First_Name__c: null,
        Last_Name__c: null,
    ...
    handleBookingChange(event) {
        if (event.target.value != null && event.target.value != '') {
            this.Customer_Registration__c.Application_Booking__c = event.target.value;
            this.fetchBookingData(event.target.value, null);
        } else {
            this.Customer_Registration__c.Application_Booking__c = null;
            this.handleReset();
        }
    }
    ...
    handleUnitChange(event) {
        if (event.target.value != null && event.target.value != '') {
            this.Customer_Registration__c.Property__c = event.target.value;
            this.fetchBookingData(null, event.target.value);
        } else {
            this.Customer_Registration__c.Property__c = null;
            this.handleReset();
        }
    }
    ...
    fetchBookingData(bookingParam, unitParam) {
        ...
        getBookingData({
            ...
            console.log('result booking : ',JSON.parse(JSON.stringify(result)));
                ...
                let firstName = null;
                let lastName = null;
                let Name = result.PropStrength__Primary_Applicant_Name__c !== undefined ? result.PropStrength__Primary_Applicant_Name__c : '';
                ...
                lastName = lastname;
                this.Customer_Registration__c.Application_Booking__c = (this.Customer_Registration__c.Application_Booking__c == null || this.Customer_Registration__c.Application_Booking__c == '') ? result.Id !== undefined ? result.Id : '' : this.Customer_Registration__c.Application_Booking__c != result.Id ? result.Id : this.Customer_Registration__c.Application_Booking__c;
                this.Customer_Registration__c.Property__c = (this.Customer_Registration__c.Property__c == null || this.Customer_Registration__c.Property__c == '') ? result.PropStrength__Property__c !== undefined ? result.PropStrength__Property__c : '' : this.Customer_Registration__c.Property__c != result.PropStrength__Property__c ? result.PropStrength__Property__c : this.Customer_Registration__c.Property__c;
                this.Customer_Registration__c.First_Name__c = firstName;
                this.Customer_Registration__c.Last_Name__c = lastname;
                this.Customer_Registration__c.Mobile_Number__c = result.PropStrength__Applicant_Mobile__c !== undefined ? result.PropStrength__Applicant_Mobile__c : '';
                this.Customer_Registration__c.Email_Address__c = result.PropStrength__Applicant_Email__c !== undefined ? result.PropStrength__Applicant_Email__c : '';
                this.Customer_Registration__c.Address__c = result.PropStrength__Applicant_Address__c;
                ...
                this.Customer_Registration__c.Residential_Status__c = result.PropStrength__Applicant_Residence_Status__c != undefined ? result.PropStrength__Applicant_Residence_Status__c : null ;;
                this.Customer_Registration__c.City__c = result.PropStrength__Primary_Customer__r.MailingCity != undefined ? result.PropStrength__Primary_Customer__r.MailingCity : null;
